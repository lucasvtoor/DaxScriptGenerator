...
public class Dax
{
   #region Library
    ...
    public class Column
    {
        public void RelateTo(string tableName, string columnName)
        {
            
        }

        public void RelateTo(Column column)
        {
    ...
    public class Table
    {
        ...
        public Measure AddMeasure(string name, string expression, string displayFolder)
        {
            return new Measure();
        }

        public Measure AddMeasure(string name, DaxType expression, string displayFolder)
        {
            return new Measure();
        }
    }
